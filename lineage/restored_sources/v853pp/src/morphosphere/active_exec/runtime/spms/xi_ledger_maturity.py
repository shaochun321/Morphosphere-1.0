...
Design principles:
  ...
  - Relation entropy is read-only: can trigger review but NOT freeze (v8.2 §9.4)
...
class RelationEntropyRecord(BaseModel):
    ...
    FORBIDDEN: freeze P/R, select Omega, generate T_seed, mainline truth
    """
    ...
    forbidden_use: str = Field(default="freeze_pr,select_omega,generate_tseed,mainline_truth")
    created_at: Optional[str] = Field(default=None)
