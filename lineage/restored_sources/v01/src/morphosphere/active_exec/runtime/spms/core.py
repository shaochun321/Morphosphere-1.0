...
V8.3 §5: These are the five minimal SPMS tables that give P/R confirmation
...
Design principles:
  ...
  - MaskingCounterevidenceRecord is the P/R confirmation hard gate.
"""
import hashlib
import json
import uuid
...
MASKING_VERDICTS_V85 = MASKING_VERDICTS
