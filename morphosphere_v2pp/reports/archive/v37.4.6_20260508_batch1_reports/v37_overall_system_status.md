...
- [x] `spacetime_cell`: **3000** 行已生成
- [x] `information_fiber`: **3000** 行已生成
- [x] `spacetime_fiber_binding`: **3000** 行已生成
- [x] `transport_current_edge`: **5400** 行已生成
- [x] `object_hypothesis`: **36** 行已生成
- [x] `occupancy_measure`: **216** 行已生成
- [x] `pr_graph_transition_record`: **72** 行已生成
- [x] `masking_counterevidence_record`: **72** 行已生成
- [x] `xi_residue_record`: **18** 行已生成
- [ ] `v368_free_energy_routing`: (未分配或为空)
